...
const Founder = () => {
  ...
  return (
    ...
    <div className='col-sm-12 col-md-8 col-xl-6 m-auto founder'>
        ...
        <p className=' text mt-5 mb-5  colw'>يهدف المقياس إلى الكشف عن مستويات تقدير الذات لدى الكبار، وبعد الانتهاء من الإجابة على الفقرات يصدر تقرير يوضح مستوى تقديرك لذاتك</p>
